...
namespace glm
{
	...
	template<typename T, qualifier Q>
	GLM_FUNC_QUALIFIER mat<4, 4, T, Q> interpolate(mat<4, 4, T, Q> const& m1, mat<4, 4, T, Q> const& m2, T const theta)
	{
		...
		mat<4, 4, T, Q> out = axisAngleMatrix(dltAxis, dltAngle * theta) * m1rot;
		out[3][0] = m1[3][0] + theta * (m2[3][0] - m1[3][0]);
		out[3][1] = m1[3][1] + theta * (m2[3][1] - m1[3][1]);
		out[3][2] = m1[3][2] + theta * (m2[3][2] - m1[3][2]);
		return out;
	}
}//namespace glm
